...
export interface ApiMainMain extends Schema.SingleType {
  ...
  attributes: {
    ...
    Team: Attribute.DynamicZone<['content.text-box']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Slug: Attribute.UID<'api::service.service', 'navTitle'>;
    Description: Attribute.Text;
    leftColumn: Attribute.RichText &
      Attribute.CustomField<
        'plugin::ckeditor.CKEditor',
        {
          output: 'HTML';
      ...
      >;
    rightColumn: Attribute.RichText &
      Attribute.CustomField<
        'plugin::ckeditor.CKEditor',
        {
          output: 'HTML';
